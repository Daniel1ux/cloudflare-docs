...
- **Workflow class**: the durable orchestrator. It persists state, survives restarts, and executes steps, including `step.waitForEvent` or `step.sleep`, which may be longrunning.
